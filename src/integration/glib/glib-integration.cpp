...
static GSourceFuncs watch_funcs = { watch_prepare, watch_check, watch_dispatch,
NULL };
...
static const GSourceFuncs dispatcher_funcs = { dispatcher_prepare, dispatcher_check, dispatcher_dispatch,
NULL };

Glib::BusDispatcher::BusDispatcher()
    : _ctx(NULL),
      _priority(G_PRIORITY_DEFAULT),
      _source(NULL) {
}
...
void Glib::BusDispatcher::attach(GMainContext *ctx) {
    ...
    _source = g_source_new((GSourceFuncs *) &dispatcher_funcs, sizeof(DispatcherSource));
