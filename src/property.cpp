...
Message PropertiesAdaptor::Get(const CallMessage &call) {
    ...
    LOG("requesting property %s on interface %s", property_name.c_str(), iface_name.c_str());
...
IntrospectedInterface *PropertiesAdaptor::introspect() const {
    static IntrospectedArgument Get_args[] = { { "interface_name", "s", true }, { "property_name", "s", true }, {
        "value", "v", false }, { 0, 0, 0 } };
    static IntrospectedArgument Set_args[] = { { "interface_name", "s", true }, { "property_name", "s", true }, {
        "value", "v", true }, { 0, 0, 0 } };
    static IntrospectedMethod Properties_methods[] = { { "Get", Get_args }, { "Set", Set_args }, { 0, 0 } };
    static IntrospectedMethod Properties_signals[] = { { 0, 0 } };
    static IntrospectedProperty Properties_properties[] = { { 0, 0, 0, 0 } };
    static IntrospectedInterface Properties_interface = { properties_name, Properties_methods, Properties_signals,
